        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlArticle = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlRepository = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ProfessionalExpSkills",
                columns: table => new
                {
                    SkillId = table.Column<int>(type: "integer", nullable: false),
                    ProfessionalExperienceId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfessionalExpSkills", x => new { x.SkillId, x.ProfessionalExperienceId });
                    table.ForeignKey(
                        name: "FK_ProfessionalExpSkills_ProfessionalExperiences_ProfessionalE~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfessionalExpSkills_ProfessionalExperienceId",
