...
const ThemeSwitch = () => {
	...
	const [showThemeSwitch, setShowThemeSwitch] = useState<boolean>(true);
	...
	return (
		<div
			className={`fixed top-4 right-4 z-50 transition-transform duration-300 ${
				showThemeSwitch ? "translate-y-0" : "-translate-y-20 opacity-0"
			}`}
		>
			<StyledWrapper>
...
const StyledWrapper = styled.div`
	/* The ThemeSwitch - the box around the slider */
	#theme-toggle-button {
		font-size: 17px;
		position: relative;
